...
/////////////////
const BotName = 'BOT CADANGAN☄'; 
const instagram = 'males'; 
const telegram = 'gada'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN lah goblok!!'; 
const youtube = 'https:gada';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by rido')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by rido`)
})
